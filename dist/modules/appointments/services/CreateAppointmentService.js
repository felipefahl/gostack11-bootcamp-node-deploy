...
let CreateAppointmentService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if ((0, _dateFns.getHours)(appointmentDate) < 8 || (0, _dateFns.getHours)(appointmentDate) > 17) {
      throw new _AppError.default('You can not create an before 8AM or after 5PM');
    }

    if ((0, _dateFns.isBefore)(appointmentDate, Date.now())) {
      throw new _AppError.default('You can not create an appointment on a past date');
    }
    ...
    const dateFormated = (0, _dateFns.format)(appointmentDate, "dd/MM/yyyy 'ás' HH:mm");
